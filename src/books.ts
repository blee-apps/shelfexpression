...
export const RAW_BOOKS = [
  ...
  { id: '7', isbn: '0811231941', title: "The Wall", author: 'Marlen Haushofer', year: 1963, synopsis: "While in a hunting lodge in the Austrian mountains, a woman awakens one morning to find herself separated from the rest of the world by an invisible wall. With a cat, a dog, and a cow as her sole companions, she learns how to survive and cope with her loneliness.", gr: '59468837', coverUrl: '/covers/0811231941.jpg', coverLocked: true },
  { id: '8', isbn: '203200544', title: "Perfection", author: 'Vincenzo Latronico', year: 2022, synopsis: "Millennial expat couple Anna and Tom are living the dream in Berlin, in a bright, plant-filled apartment. A sociological novel about the emptiness of contemporary existence.", gr: '203200544', coverUrl: '/covers/203200544.jpg', coverLocked: true },
  { id: '9', isbn: '0307946892', title: "Tigerman", author: 'Nick Harkaway', year: 2014, synopsis: "Sergeant Lester Ferris, a veteran of the Afghan war, serves on the island of Mancreu, a former British colony slated for destruction. He adopts a superhero persona to protect a local street kid.", gr: '19322249', coverUrl: '/covers/0307946892.jpg', coverLocked: true },
  { id: '10', isbn: '0374139946', title: "Dilla Time", author: 'Dan Charnas', year: 2022, synopsis: "The life and legacy of J Dilla, a musical genius who transformed the sound of popular music and invented a new rhythm that changed the way musicians play.", gr: '57693653' },
  { id: '11', isbn: '0812976711', title: "The Satanic Verses", author: 'Salman Rushdie', year: 1988, synopsis: "Just before dawn one winter's morning, a hijacked jumbo jet blows apart high above the English Channel. A magical realist epic about migration, faith, and transformation.", gr: '12781' },
  { id: '12', isbn: '128533513', title: "Make Something Wonderful", author: 'Steve Jobs', year: 2023, synopsis: "A curated collection of Steve Jobs's speeches, interviews, and correspondence, offering an unparalleled window into how one of the world's most creative entrepreneurs approached his life and work.", gr: '128533513', coverUrl: '/covers/128533513.jpg', coverLocked: true },
  { id: '13', isbn: '0995624233', title: "There Is No Antimemetics Division", author: 'qntm', year: 2020, synopsis: "An antimeme is an idea with self-censoring properties; an idea which, by its very nature, discourages or prevents people from spreading it. A sci-fi thriller about fighting an enemy you can't remember.", gr: '54870256', coverUrl: '/covers/0995624233.jpg', coverLocked: true },
  { id: '14', isbn: '75302296', title: "People Collide", author: 'Isle McElroy', year: 2023, synopsis: "A gender-bending, body-switching novel that explores marriage, identity, and sex, raising profound questions about the nature of true partnership.", gr: '75302296' },
  { id: '15', isbn: '123163147', title: "The Future", author: 'Naomi Alderman', year: 2023, synopsis: "A handful of friends plot a daring heist to save the world from the tech billionaires who are intent on surviving the apocalypse in their private bunkers.", gr: '123163147' },
];
